...
```bash
python3 -m unittest discover -s backtester/tests -t .   # 564 tests
...
1008 tests total, no test-framework dependency in any component (`unittest` and `node:test`).
